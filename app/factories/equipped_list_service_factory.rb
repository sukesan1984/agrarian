class EquippedListServiceFactory
  ...
  def build_by_equipment_and_player_id(equipment_model, player_id)
    return EquippedListService.new(
      ...
      both_hand: @equipped_entity_factory.build_by_part_and_user_item_id(BodyRegion::Type::BothHand, equipment_model.both_hand, player_id),
      body: @equipped_entity_factory.build_by_part_and_user_item_id(BodyRegion::Type::Body, equipment_model.body, player_id),
      head: @equipped_entity_factory.build_by_part_and_user_item_id(BodyRegion::Type::Head, equipment_model.head, player_id),
      leg: @equipped_entity_factory.build_by_part_and_user_item_id(BodyRegion::Type::Leg, equipment_model.leg, player_id))
  end
end
