class UserEncounterEnemyGroupEntityFactory
  ...
  def create_by_player_id(player_id)
    ...
    return Entity::UserEncounterEnemyGroupEntity.new(user_encounter_enemy_group, user_encounter_enemy_groups, Entity::EnemyGroupEntity.new(enemy_group, enemy_instances))
  end
end
