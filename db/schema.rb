...
ActiveRecord::Schema.define(version: 20160306085513) do
  ...
  create_table "dungeons", force: :cascade do |t|
    ...
    t.datetime "created_at",                          null: false
    t.datetime "updated_at",                          null: false
    t.integer  "max_floor",   limit: 4,   default: 0, null: false
    t.integer  "min_search",  limit: 4,   default: 0, null: false
    t.integer  "max_search",  limit: 4,   default: 0, null: false
  end
  ...
  create_table "players", force: :cascade do |t|
    ...
    t.integer  "str",              limit: 4,   default: 5,   null: false
    t.integer  "dex",              limit: 4,   default: 2,   null: false
    t.integer  "vit",              limit: 4,   default: 8,   null: false
    t.integer  "ene",              limit: 4,   default: 3,   null: false
  ...
  create_table "soldiers", force: :cascade do |t|
    t.string   "name",                    limit: 255
    t.string   "description",             limit: 255
    t.integer  "str_min",                 limit: 4
    t.integer  "dex_min",                 limit: 4
    t.integer  "vit_min",                 limit: 4
    t.datetime "created_at",                                      null: false
    t.datetime "updated_at",                                      null: false
    t.integer  "str_max",                 limit: 4
    t.integer  "dex_max",                 limit: 4
    t.integer  "vit_max",                 limit: 4
  ...
  create_table "thrown_items", force: :cascade do |t|
    ...
    t.datetime "updated_at",                         null: false
    t.integer  "lock_version", limit: 4, default: 0, null: false
    t.integer  "user_item_id", limit: 4, default: 0, null: false
  end

  add_index "thrown_items", ["area_node_id", "item_id", "user_item_id"], name: "index_thrown_items_on_area_node_id_and_item_id_and_user_item_id", unique: true, using: :btree
  ...
  create_table "user_dungeons", force: :cascade do |t|
    ...
    t.integer  "dungeon_id",     limit: 4, default: 0,     null: false
    t.integer  "current_floor",  limit: 4, default: 0,     null: false
    t.integer  "search_count",   limit: 4, default: 0,     null: false
    t.boolean  "found_footstep", limit: 1, default: false, null: false
    t.datetime "created_at",                               null: false
    t.datetime "updated_at",                               null: false
  end

  add_index "user_dungeons", ["player_id"], name: "index_user_dungeons_on_player_id", unique: true, using: :btree
