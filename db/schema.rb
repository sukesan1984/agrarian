...
ActiveRecord::Schema.define(version: 20150719064313) do
  ...
  add_index "user_equipments", ["player_id", "body_region"], name: "index_user_equipments_on_player_id_and_body_region", using: :btree
